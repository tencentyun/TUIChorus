...
protocol ChorusMainRootViewDelegate: NSObject {
    func enterRoom(roomId: String)
    func createRoom()
}

class ChorusMainRootView: UIView {
    ...
    weak var delegate: ChorusMainRootViewDelegate? = nil
...
private extension String {
    static let roomNumberText = TRTCChorusLocalize("Demo.TRTC.LiveRoom.roomNumber")
    static let enterRoomNumberText = TRTCChorusLocalize("Demo.TRTC.LiveRoom.enterRoomNumber")
    static let enterRoomText = TRTCChorusLocalize("Demo.TRTC.LiveRoom.enterRoom")
    static let createRoomText = TRTCChorusLocalize("Demo.TRTC.LiveRoom.createRoom")
}
