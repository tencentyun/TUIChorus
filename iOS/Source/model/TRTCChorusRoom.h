...
@interface TRTCChorusRoom : NSObject
/**
* 获取 TRTCChorus 单例对象
*
...
*/
- (void)setDelegate:(id<TRTCChorusRoomDelegate>)delegate NS_SWIFT_NAME(setDelegate(delegate:));
...
*/
- (void)createRoom:(int)roomID roomParam:(ChorusParam *)roomParam callback:(ActionCallback _Nullable)callback NS_SWIFT_NAME(createRoom(roomID:roomParam:callback:));
...
*/
- (void)getRoomInfoList:(NSArray<NSNumber *> *)roomIdList callback:(ChorusRoomInfoCallback _Nullable)callback NS_SWIFT_NAME(getRoomInfoList(roomIdList:callback:));
