//
//  TRTCChorusAudienceTableViewCell.swift
//  TUIChorus
//
...
import UIKit
import TXAppBasic
class TRTCChorusAudienceTableViewCell: UITableViewCell {
    ...
    override func prepareForReuse() {
        ...
        model = nil
        iconView.image = UIImage.init(named: "Chorus_placeholder_avatar")
    }
    ...
    func setCell(model: AudienceInfoModel) {
        ...
        iconView.kf.setImage(with: avatarUrl, placeholder: UIImage.init(named: "Chorus_placeholder_avatar"))
