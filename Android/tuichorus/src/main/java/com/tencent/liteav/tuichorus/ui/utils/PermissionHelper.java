package com.tencent.liteav.tuichorus.ui.utils;
    ...
    public static void requestPermission(Context context, @PermissionType int type, final PermissionCallback callback) {
        ...
        switch (type) {
            case PERMISSION_MICROPHONE: {
                ...
                reasonTitle = resources.getString(R.string.tuichorus_permission_mic_reason_title, appName);
                reason = resources.getString(R.string.tuichorus_permission_mic_reason);
                deniedAlert = resources.getString(R.string.tuichorus_tips_start_audio);
                break;
            }
            default:
                break;
