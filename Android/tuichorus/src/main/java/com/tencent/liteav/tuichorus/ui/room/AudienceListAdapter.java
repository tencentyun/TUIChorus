...
public class AudienceListAdapter extends RecyclerView.Adapter<AudienceListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View           view     = inflater.inflate(R.layout.tuichorus_item_audience, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Context context,
            ...
            ImageLoader.loadImage(context, mImgHead, entity.userAvatar, R.drawable.tuichorus_ic_head);
        }
