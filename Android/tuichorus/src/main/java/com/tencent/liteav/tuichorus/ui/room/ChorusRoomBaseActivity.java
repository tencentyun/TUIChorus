    ...
    private void switchNetworkStatus(int localQuality, int remoteQuality) {
        switch (localQuality) {
            ...
            case TCConstants.TRTCQUALITY_GOOD:
                mImageLocalNetwork.setImageResource(R.drawable.tuichorus_ic_signal_good);
            ...
            case TCConstants.TRTCQUALITY_BAD:
                mImageLocalNetwork.setImageResource(R.drawable.tuichorus_ic_signal_poor);
            ...
            case TCConstants.TRTCQUALITY_DOWN:
                mImageLocalNetwork.setImageResource(R.drawable.tuichorus_ic_signal_bad);
        ...
        switch (remoteQuality) {
            case TCConstants.TRTCQUALITY_EXCELLENT:
            case TCConstants.TRTCQUALITY_GOOD:
                mImageRemoteNetwork.setImageResource(R.drawable.tuichorus_ic_signal_good);
            ...
            case TCConstants.TRTCQUALITY_POOR:
            case TCConstants.TRTCQUALITY_BAD:
                mImageRemoteNetwork.setImageResource(R.drawable.tuichorus_ic_signal_poor);
            ...
            case TCConstants.TRTCQUALITY_VBAD:
            case TCConstants.TRTCQUALITY_DOWN:
                mImageRemoteNetwork.setImageResource(R.drawable.tuichorus_ic_signal_bad);
