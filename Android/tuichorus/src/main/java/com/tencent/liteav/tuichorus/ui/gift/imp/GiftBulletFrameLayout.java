...
import com.tencent.liteav.tuichorus.ui.gift.utils.AnimationUtils;
...
public class GiftBulletFrameLayout extends FrameLayout implements Handler.Callback {
    ...
    private void initView() {
        mRootView = mInflater.inflate(R.layout.tuichorus_layout_gift_bullet, null);
    ...
    public boolean setGift(GiftInfo gift) {
        ...
        if (!TextUtils.isEmpty(gift.title)) {
            String tip = String.format(mContext.getString(R.string.tuichorus_gift_send), gift.title);
