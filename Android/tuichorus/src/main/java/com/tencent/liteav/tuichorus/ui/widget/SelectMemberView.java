...
public class SelectMemberView extends BottomSheetDialog {
    ...
    public SelectMemberView(@NonNull Context context) {
        ...
        setContentView(R.layout.tuichorus_view_select);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        if (mPusherListRv != null) {
            ...
            mPusherListRv.addItemDecoration(new SpaceDecoration(dp2px(mContext, 15), 1));
        }
    ...
    public void updateCloseStatus(boolean isClose) {
        if (isClose) {
            mIvCloseSeat.setImageResource(R.drawable.tuichorus_open_seat);
            mTVCloseSeat.setText(mContext.getString(R.string.tuichorus_unlock));
        } else {
            mIvCloseSeat.setImageResource(R.drawable.tuichorus_close_seat);
            mTVCloseSeat.setText(mContext.getString(R.string.tuichorus_lock));
        }
    }
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final MemberEntity model,
                ...
                if (model.type == MemberEntity.TYPE_IDEL) {
                    ...
                    mButtonInvite.setText(context.getResources().getString(R.string.tuichorus_tv_invite));
                } else if (model.type == MemberEntity.TYPE_WAIT_AGREE) {
                    mButtonInvite.setVisibility(View.VISIBLE);
                    mButtonInvite.setText(R.string.tuichorus_agree);
                } else {
                ...
                ImageLoader.loadImage(context, mImageAvatar, model.userAvatar, R.drawable.tuichorus_ic_cover);
