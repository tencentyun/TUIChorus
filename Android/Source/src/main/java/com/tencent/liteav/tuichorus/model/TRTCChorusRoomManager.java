...
public class TRTCChorusRoomManager {
    private static final String                TAG = "TRTCChorusRoomManager";
    private static       TRTCChorusRoomManager sInstance;
    private              RoomCallback          mRoomCallback;

    public static TRTCChorusRoomManager getInstance() {
        if (sInstance == null) {
            synchronized (TRTCChorusRoomManager.class) {
                if (sInstance == null) {
                    sInstance = new TRTCChorusRoomManager();
                }
            }
        }
        return sInstance;
