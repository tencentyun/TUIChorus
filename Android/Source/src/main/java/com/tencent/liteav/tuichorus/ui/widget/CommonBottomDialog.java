...
public class CommonBottomDialog extends BottomSheetDialog {
    ...
    public CommonBottomDialog(Context context) {
        ...
        setContentView(R.layout.tuichorus_view_bottom_dialog);
    ...
    private TextView createButton(final int position, final String text) {
        ...
        textView.setTextColor(getContext().getResources().getColor(R.color.tuichorus_color_bg_text_bottom));
        textView.setBackgroundResource(R.drawable.tuichorus_bg_confirm_dialog);
